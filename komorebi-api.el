...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-animation-style ()
  "Set the ease function for movement animations
Usage: komorebic.exe animation-style [OPTIONS]

Options:
-s, --style (linear) Desired ease function for animation
Possible values:
linear,ease-in-sine,ease-out-sine,ease-in-out-sine,ease-in-quad,ease-out-quad
ease-in-out-quad,ease-in-cubic,ease-in-out-cubic,ease-in-quart,ease-out-quart
ease-in-out-quart,ease-in-quint,ease-out-quint,ease-in-out-quint,ease-in-expo
ease-out-expo,ease-in-out-expo,ease-in-circ,ease-out-circ,ease-in-out-circ
ease-in-back,ease-out-back,ease-in-out-back,ease-in-elastic,ease-out-elastic
ease-in-out-elastic,ease-in-bounce,ease-out-bounce,ease-in-out-bounce
-h, --help Print help"
  (interactive)
  (komorebi-api--execute "animation-style" ))
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-application-specific-configuration-schema ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-bar-configuration ()
...
(cl-defun komorebi-api-border-colour (&key r g b)
...
-h, --help Print help"
  (komorebi-api--execute "border-colour" r g b))
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-clear-all-workspace-rules ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-complete-configuration ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-configuration ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-disable-autostart ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-enable-autostart ()
...
-h, --help Print help"
  (interactive)
  (komorebi-api--execute "enable-autostart" ))
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-fetch-app-specific-configuration ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-focus-last-workspace ()
...
Arguments:
TARGET_MONITOR Target monitor index (zero-indexed)
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-force-focus ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-generate-static-config ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-global-state ()
...
Usage: komorebic.exe initial-workspace-rule <IDENTIFIER> <ID> <MONITOR>
<WORKSPACE>
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-minimize ()
...
Usage: komorebic.exe monitor-index-preference <INDEX_PREFERENCE> <LEFT> <TOP>
<RIGHT> <BOTTOM>
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-monitor-information ()
...
Usage: komorebic.exe monitor-work-area-offset <MONITOR> <LEFT> <TOP> <RIGHT>
<BOTTOM>
...
Usage: komorebic.exe move-to-monitor-workspace <TARGET_MONITOR>
<TARGET_WORKSPACE>
...
Usage: komorebic.exe named-workspace-layout-rule <WORKSPACE>
<AT_CONTAINER_COUNT> <LAYOUT>
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-new-workspace ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-notification-schema ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-promote-focus ()
...
STATE_QUERY
Possible values:
focused-monitor-index,focused-workspace-index,focused-container-index
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-quick-load-resize ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-quick-save-resize ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-quickstart ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-reload-configuration ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-restore-windows ()
...
Usage: komorebic.exe send-to-monitor-workspace <TARGET_MONITOR>
<TARGET_WORKSPACE>
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-socket-schema ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-stack-all ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-static-config-schema ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-toggle-cross-monitor-move-behaviour ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-toggle-float-override ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-toggle-float ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-toggle-maximize ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-toggle-monocle ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-toggle-mouse-follows-focus ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-toggle-pause ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-toggle-tiling ()
  "Toggle window tiling on the focused workspace
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-toggle-title-bars ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-toggle-transparency ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-toggle-window-container-behaviour ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-toggle-workspace-float-override ()
  "Enable or disable float override, which makes it so every new window opens in
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-toggle-workspace-window-container-behaviour ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-unmanage ()
...
-h, --help Print help (see a summary with '-h')"
  ...
  ;;;###autoload
(cl-defun komorebi-api-unstack-all ()
...
-h, --help Print help"
  ...
  ;;;###autoload
(cl-defun komorebi-api-visible-windows ()
...
(cl-defun komorebi-api-workspace-layout-rule (&key monitor workspace at-container-count layout)
  "Add a dynamic layout rule for the specified workspace
Usage: komorebic.exe workspace-layout-rule <MONITOR> <WORKSPACE>
<AT_CONTAINER_COUNT> <LAYOUT>
